...
import { ArrowLeft, Mail, Phone, Lock, Truck } from "lucide-react";
...
export default function CollectorLogin() {
  ...
  const handleEmailLogin = (e) => {
    e.preventDefault();
    // Mock login - navigate to collector dashboard
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl mb-2 text-gray-900">Collector Sign In</h1>
          <p className="text-gray-600">Access your collector dashboard</p>
        </div>
        ...
        <p className="text-center mt-6 text-gray-600">
          ...
          <button
            onClick={() => router.push("/auth/collector/signup")}
